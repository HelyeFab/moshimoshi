 ...
 */
export function createMockCheckoutSessionCompleted(
 ...
 */
export function createMockSubscriptionCreated(
 ...
 */
export function createMockInvoicePaymentSucceeded(
  ...
  const invoice: any = {
    ...
    total_tax_amounts: [],
    transfer_data: null,
    webhooks_delivered_at: Date.now() / 1000,
    ...overrides,
  };
 ...
 */
export function createMockInvoicePaymentFailed(
  overrides?: Partial<Stripe.Invoice>
): Stripe.Event {
  const invoice = createMockInvoicePaymentSucceeded(overrides).data.object as any;
 ...
 */
export function createMockSubscriptionDeleted(
  overrides?: Partial<Stripe.Subscription>
): Stripe.Event {
  const subscription = createMockSubscriptionCreated(overrides).data.object as any;
