...
class IntegrityMockFactory {
  ...
  static createNewsArticleWithMissingAudio(overrides) {
    return this.createNewsArticle(
      Object.assign({ hasAudio: false, audioUrl: undefined, audioSegments: undefined }, overrides)
    )
  }
  static createNewsArticleWithMissingTranslation(overrides) {
    return this.createNewsArticle(
      Object.assign({ hasTranslation: false, translation: undefined }, overrides)
    )
  }
  static createNewsArticleWithMissingWordExplanations(overrides) {
    return this.createNewsArticle(
      Object.assign({ hasWordExplanations: false, wordExplanations: undefined }, overrides)
    )
  }
