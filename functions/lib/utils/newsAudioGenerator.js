...
async function generateBatchAudio(article, options = {}) {
  ...
  try {
    ...
    const hasAllAudio =
      ((_d = result.titleAudio) === null || _d === void 0 ? void 0 : _d.url) &&
      ((_e = result.summaryAudio) === null || _e === void 0 ? void 0 : _e.url) &&
      ((_f = result.contentAudio) === null || _f === void 0 ? void 0 : _f.url)
    const hasAnyAudio =
      ((_g = result.titleAudio) === null || _g === void 0 ? void 0 : _g.url) ||
      ((_h = result.summaryAudio) === null || _h === void 0 ? void 0 : _h.url) ||
      ((_j = result.contentAudio) === null || _j === void 0 ? void 0 : _j.url)
    if (hasAllAudio) {
