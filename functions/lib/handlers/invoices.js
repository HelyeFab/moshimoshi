...
exports.applyInvoiceEvent = applyInvoiceEvent;
exports.isSubscriptionInvoice = isSubscriptionInvoice;
exports.getInvoicePeriod = getInvoicePeriod;
exports.debugInvoice = debugInvoice;
 ...
 */
async function applyInvoiceEvent(event) {
 ...
 */
async function handleInvoicePaymentSucceeded(invoice, customerId) {
 ...
 * @param customerId - The Stripe customer ID
 */
async function handleInvoicePaymentFailed(invoice, customerId) {
    var _a;
    ...
    const facts = {
        ...
        lastPaymentFailureReason: ((_a = invoice.last_payment_error) === null || _a === void 0 ? void 0 : _a.message) || 'Unknown',
 ...
 * @param customerId - The Stripe customer ID
 */
async function handleInvoiceCreated(invoice, customerId) {
 ...
 * @param customerId - The Stripe customer ID
 */
async function handleInvoiceFinalized(invoice, customerId) {
 ...
 * @param customerId - The Stripe customer ID
 */
async function handlePaymentActionRequired(invoice, customerId) {
 ...
 */
async function logPaymentSuccess(invoice) {
 ...
 */
async function logPaymentFailure(invoice) {
