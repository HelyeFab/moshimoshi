...
exports.detectWordType = detectWordType;
exports.detectWordTypeWithContext = detectWordTypeWithContext;
exports.detectWordTypes = detectWordTypes;
exports.isConjugatableType = isConjugatableType;
exports.getConjugationType = getConjugationType;
/**
 * JMDict part-of-speech codes to verb type mapping
 * Based on JMdict XML entity definitions
 */
const JMDICT_VERB_MAPPINGS = {
    // Ichidan verbs
    'v1': 'Ichidan',
 ...
 */
function detectFromPattern(word, reading) {
    ...
    if (godanEnding && lastChar !== 'る') {
        return {
            ...
            conjugationType: 'Godan',
            isConjugatable: true,
            confidence: godanEnding.confidence,
            details: {
                verbEnding: lastChar
            }
        };
 ...
 */
function detectWordTypeWithContext(word, reading, partsOfSpeech, meaning) {
    // Get base detection
    ...
    if (result.confidence === 'low' && meaning) {
        ...
        if (lowerMeaning.startsWith('to ')) {
            ...
            if (word.endsWith('る')) {
                ...
                result = Object.assign(Object.assign({}, result), { baseType: 'Ichidan', conjugationType: 'Ichidan', isConjugatable: true, confidence: 'medium' });
            }
        }
    }
    return result;
 ...
 */
function detectWordTypes(words) {
    return words.map(w => detectWordTypeWithContext(w.word, w.reading, w.partsOfSpeech, w.meaning));
}
/**
 * Check if a word type is conjugatable
 */
function isConjugatableType(type) {
 ...
 */
function getConjugationType(type) {
...
//# sourceMappingURL=wordTypeDetector.js.map