...
class TranslationProcessor extends BaseProcessor_1.BaseProcessor {
    ...
    async process(request, config) {
        ...
        try {
            ...
            if (!translations_1.translationCache || typeof translations_1.translationCache.getCachedTranslation !== 'function') {
        ...
        try {
            ...
            try {
                ...
                if (!translations_1.translationCache || typeof translations_1.translationCache.storeTranslation !== 'function') {
