...
exports.manualArticleAudioGenerator = exports.scheduledArticleAudioGenerator = void 0;
 ...
 */
async function findArticlesMissingAudio(limit) {
    const snapshot = await db.collection('news_articles').get();
    const articlesMissingAudio = [];
 ...
 */
async function generateMissingAudio(options = {}) {
    var _a, _b, _c;
    ...
    for (let i = 0; i < articles.length; i++) {
        ...
        try {
            ...
            const result = await (0, newsAudioGenerator_1.generateBatchAudio)({
                id: article.id,
                title: article.title,
            ...
            const generated = [];
            if (((_a = result.titleAudio) === null || _a === void 0 ? void 0 : _a.url) && !article.generatedTitleAudioUrl)
                generated.push('title');
            if (((_b = result.summaryAudio) === null || _b === void 0 ? void 0 : _b.url) && !article.generatedSummaryAudioUrl)
                generated.push('summary');
            if (((_c = result.contentAudio) === null || _c === void 0 ? void 0 : _c.url) && !article.generatedContentAudioUrl)
 ...
 */
exports.scheduledArticleAudioGenerator = (0, scheduler_1.onSchedule)({
 ...
 */
exports.manualArticleAudioGenerator = (0, https_1.onCall)({
    memory: '1GiB',
    timeoutSeconds: 540,
    ...
    logger.info('[ArticleAudioGenerator] Manual trigger initiated', {
        ...
        maxArticles: (_c = request.data) === null || _c === void 0 ? void 0 : _c.maxArticles,
    });
    const result = await generateMissingAudio({
        maxArticles: ((_d = request.data) === null || _d === void 0 ? void 0 : _d.maxArticles) || MAX_ARTICLES_PER_RUN,
    });
    return result;
});
//# sourceMappingURL=articleAudioGenerator.js.map