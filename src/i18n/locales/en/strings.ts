export const strings = {
  ...
  stories: {
    ...
    description: "Immerse yourself in graded reading stories with furigana and grammar highlighting",
  ...
  auth: {
    ...
    signup: {
      ...
      form: {
        ...
        passwordRequirements: "At least 8 characters with 1 uppercase, 1 number, and 1 special character",
  ...
  account: {
    ...
    deleteAccountDialog: {
      ...
      message: "Are you sure you want to delete your account? This will permanently delete all your data including progress, achievements, and subscription. This action cannot be undone.",
  ...
  subscription: {
    ...
    messages: {
      ...
      subscriptionCanceled: "Your subscription has been successfully canceled. You'll retain access until {{date}}.",
  ...
  kana: {
    ...
    review: {
      ...
      vocabulary: {
        ...
        wanikaniMockData: "WaniKani API is not configured properly. Please switch to JMdict or configure a valid WaniKani API token.",
        wanikaniInvalidKey: "WaniKani API key is invalid. Please check your API configuration or use JMdict instead.",
        wanikaniServiceDown: "WaniKani service is temporarily unavailable. Please try again later or use JMdict.",
        ...
        loadingCache: "Loading WaniKani vocabulary database for the first time... This may take a moment.",
    ...
    privacy: {
      ...
      sections: {
        introduction: {
          ...
          content: "Welcome to Moshimoshi. We are committed to protecting your personal information and your right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Japanese language learning application.",
          agreement: "By using Moshimoshi, you agree to the collection and use of information in accordance with this policy."
        },
        collection: {
        ...
        security: {
          ...
          location: {
            title: "Data Location",
            content: "Your data is stored on secure servers provided by Google Firebase, located in the United States."
          },
          local: {
            title: "Local Storage",
            content: "Some data is stored locally on your device for offline access and performance optimization."
          }
        },
        rights: {
  ...
  flashcards: {
    ...
    noDecksDescription: "Start by creating your first flashcard deck to begin your learning journey",
  ...
  credits: {
    ...
    subtitle: "Moshimoshi is built on the shoulders of giants. We gratefully acknowledge the following projects and communities.",
    ...
    license: {
      title: "License & Usage",
      description: "Moshimoshi respects the licenses of all third-party projects. We use these resources in compliance with their respective licenses. For detailed license information, please refer to each project's official documentation."
    },
