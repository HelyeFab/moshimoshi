export const strings = {
  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        hiragana: '5 Hiragana practice sessions per day',
        katakana: '5 Katakana practice sessions per day',
        basicTracking: 'Basic progress tracking',
        communitySupport: 'Community support',
      },
      monthly: {
        unlimitedHiragana: 'Unlimited Hiragana practice',
        unlimitedKatakana: 'Unlimited Katakana practice',
        unlimitedKanji: 'Unlimited Kanji practice',
        kanjiConnection: 'Exclusive Kanji Connection',
        textbookVocab: 'Exclusive Access to Textbook Vocabulary',
        moshiComics: 'Exclusive Access to Moshi Comics',
        advancedSRS: 'Advanced SRS algorithm',
        ankiImports: 'Anki imports',
        unlimitedLists: 'Unlimited My Lists',
        prioritySupport: 'Priority support',
        cancelAnytime: 'Cancel anytime',
      },
      yearly: {
