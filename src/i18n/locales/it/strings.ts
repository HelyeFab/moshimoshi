export const strings = {
  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        hiragana: '5 sessioni di pratica Hiragana al giorno',
        katakana: '5 sessioni di pratica Katakana al giorno',
        basicTracking: 'Tracciamento progresso base',
        communitySupport: 'Supporto community',
      },
      monthly: {
        unlimitedHiragana: 'Pratica Hiragana illimitata',
        unlimitedKatakana: 'Pratica Katakana illimitata',
        unlimitedKanji: 'Pratica Kanji illimitata',
        kanjiConnection: 'Kanji Connection esclusivo',
        textbookVocab: 'Accesso esclusivo al vocabolario dei libri di testo',
        moshiComics: 'Accesso esclusivo a Moshi Comics',
        advancedSRS: 'Algoritmo SRS avanzato',
        ankiImports: 'Importazioni Anki',
        unlimitedLists: 'My Lists illimitati',
        prioritySupport: 'Supporto prioritario',
        cancelAnytime: 'Cancella in qualsiasi momento',
      },
      yearly: {
