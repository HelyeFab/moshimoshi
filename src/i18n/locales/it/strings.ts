export const strings = {
  ...
  dashboard: {
    ...
    cards: {
      ...
      grammar: {
        title: 'Grammatica',
        subtitle: '文法',
        description: 'Sfoglia i punti di grammatica N5 e N4',
      },
      particles: {
        title: 'Particles',
        subtitle: '助詞',
  ...
  account: {
    ...
    deleteAccountDialog: {
      ...
      cancelText: 'Annulla',
      reasonLabel: 'Perché te ne vai? (opzionale)',
      reasonPlaceholder: 'Seleziona un motivo...',
      reasons: {
        not_using: 'Non uso più l\'app',
        privacy_concerns: 'Preoccupazioni sulla privacy',
        found_alternative: 'Ho trovato un\'alternativa',
        technical_issues: 'Problemi tecnici',
        too_expensive: 'Troppo costoso',
        other: 'Altro',
      },
      feedbackLabel: 'Hai un feedback per noi? (opzionale)',
      feedbackPlaceholder: 'Aiutaci a migliorare...',
      confirmPhraseLabel: 'Digita {phrase} per confermare',
      confirmPhrase: 'DELETE MY ACCOUNT',
      recoveryInfo:
        'Il tuo account verrà disattivato immediatamente e eliminato permanentemente dopo 30 giorni. Contatta il supporto entro questo periodo per recuperare il tuo account.',
      deleting: 'Eliminazione...',
    },
    toastMessages: {
      profileUpdated: 'Profilo aggiornato con successo!',
      accountDeletionRequested: 'Eliminazione account richiesta. Contatta il supporto.',
      accountDeletionSuccess: 'Eliminazione account programmata. Verrai disconnesso.',
      confirmPhraseError: 'Per favore digita "DELETE MY ACCOUNT" per confermare',
    },
  },
  statistics: {
  ...
  errors: {
    auth: {
      ...
      accountScheduledForDeletion: 'Questo account è stato programmato per l\'eliminazione. Contatta il supporto entro 30 giorni per recuperarlo.',
  ...
  entitlements: {
    ...
    messages: {
      ...
      lookupLimitReached: 'Limite giornaliero delle ricerche raggiunto. Riprova domani.',
      signUpForMore: 'Registrati gratis per ottenere più pratiche giornaliere',
  ...
  pricing: {
    ...
    planDescriptions: {
      free: 'Inizia con le funzionalità di base',
      premiumMonthly: 'Accesso completo con fatturazione mensile',
      premiumYearly: 'Miglior valore con fatturazione annuale',
    },
    billingToggle: {
      monthly: 'Mensile',
      yearly: 'Annuale',
    ...
    features: {
      ...
      free: {
        ...
        dailyPractice: 'Pratica quotidiana di kana, kanji ed esercizi',
        limitedStoriesNews: 'Storie e notizie limitate',
        basicProgressTracking: 'Monitoraggio base dei progressi',
        learnAtYourPace: 'Impara con i tuoi tempi',
      },
      monthly: {
        everythingFree: 'Tutto in Gratuito, più:',
        learnFaster: 'Impara più velocemente con pratica illimitata',
        readMore: 'Leggi di più con storie, notizie e fumetti illimitati',
        goDeeper: 'Approfondisci con Kanji Connection completo + vocabolario dei libri di testo',
        buildHabits: 'Costruisci abitudini reali con esercizi e padronanza illimitati',
        crossDeviceSync: 'Mantieni i progressi ovunque con la sincronizzazione tra dispositivi',
        prioritySupport: 'Supporto prioritario',
        futureFeaturesUnlimited: 'Ogni nuova funzionalità inclusa — sempre illimitata',
      },
      yearly: {
        everythingMonthly: 'Tutto in Premium Mensile',
        twoMonthsFree: 'Miglior valore — risparmia 7% (2 mesi gratis)',
      },
    },
    comparison: {
  ...
  grammarStall: {
    title: 'Punti di grammatica JLPT {{level}}',
    description: 'Padroneggia la grammatica giapponese con {{count}} punti di grammatica essenziali.',
    jlptBadge: 'JLPT {{level}}',
    levelSelectorLabel: 'Scegli un livello JLPT',
    levelOption: 'JLPT {{level}} ({{count}})',
    groupByLabel: 'Raggruppa per',
    groupByChapter: 'Capitoli',
    groupByCategory: 'Categorie',
    showFuriganaLabel: 'Mostra furigana',
    showFuriganaDescription: 'Mostra aiuti di lettura sopra i kanji',
    searchLabel: 'Cerca grammatica',
    searchPlaceholder: 'Cerca titoli, tag o descrizioni',
    searchHelper: 'Cerca in tutti i livelli JLPT.',
    searchEmpty: 'Nessun punto di grammatica trovato.',
    searchGroupLabel: 'Risultati JLPT {{level}}',
    chapterFallback: 'Capitolo {{order}}',
    explanation: 'Spiegazione',
    structure: 'Struttura',
    examples: 'Esempi',
    related: 'Grammatica Correlata',
    practice: 'Esercizi di Pratica',
    practiceMode: 'Modalità pratica',
    lessonMode: 'Modalità lezione',
    practiceAction: 'Pratica',
    lessonAction: 'Lezione',
    example: 'Esempio',
    breakdown: 'Analisi',
    note: 'Nota',
    pattern: 'Schema',
    componentExamples: 'Esempi',
    breadcrumb: {
      learn: 'Impara',
      grammar: 'Grammatica',
    },
    practiceUi: {
      ...
      notFoundTitle: 'Esercizi non trovati',
      notFoundBody: 'Non siamo riusciti a caricare gli esercizi per questo punto di grammatica.',
      backToPoint: 'Torna al punto di grammatica',
      completeTitle: 'Esercizio completato!',
      completeBody: 'Ottimo lavoro con questo punto di grammatica.',
      correct: 'Corretto',
      incorrect: 'Errato',
      accuracy: 'Precisione',
      practiceAgain: 'Ripeti la pratica',
      noExercisesTitle: 'Nessun esercizio disponibile',
      noExercisesBody: 'Non sono ancora disponibili esercizi per questo punto di grammatica.',
      correctShort: 'Corretto!',
      incorrectShort: 'Quasi...',
      ...
      chooseEnglishMatch: 'Scegli la corrispondenza in inglese:',
      submitMatches: 'Invia abbinamenti',
    },
  },
  reviewPrompts: {
    vocabulary: {
  ...
  lists: {
    ...
    deleteAllDialog: {
      ...
      message: 'Sei sicuro di voler eliminare tutte le {{count}} liste? Questa azione non può essere annullata e tutti gli elementi saranno eliminati permanentemente.',
      confirm: 'Elimina tutto ({{count}})',
    },
    labels: {
      itemCount: '{count} elementi',
    ...
    success: {
      ...
      allDeleted: 'Tutte le {{count}} liste sono state eliminate con successo',
    ...
    errors: {
      ...
      deleteFailed: 'Eliminazione lista fallita',
      someDeleteFailed: '{{success}} liste eliminate, {{failed}} fallite',
      ...
      addFailed: 'Impossibile aggiungere! Controlla il tipo di lista.',
  ...
  youtubeShadowing: {
    ...
    beta: {
      label: 'Beta',
      tooltip: 'Gli strumenti di shadowing stanno migliorando mentre perfezioniamo la sincronizzazione delle trascrizioni.',
    },
    header: {
    ...
    resegment: {
      status: {
        inProgress: 'Risegmentazione della trascrizione in corso...',
        completeAi: 'Risegmentazione completata (IA tramite {{provider}}).',
        completeDeterministic: 'Risegmentazione completata (deterministica: {{reason}}, provider: {{provider}}).',
      },
      toast: {
        completeAi: 'Risegmentazione IA completata ({{provider}}).',
        deterministicFallback: 'Fallback deterministico: {{reason}} ({{provider}}).',
      },
      button: {
        idle: 'Risegmentazione IA',
        loading: 'Risegmentazione in corso...',
        title: 'Esegui risegmentazione della trascrizione',
      },
    },
  ...
  flashcards: {
    ...
    modes: {
      ...
      mistakeReplay: {
        name: 'Ripeti errori',
        description: 'Rivedi gli errori delle ultime sessioni',
        history: 'Cronologia sessioni',
        session: 'Sessione {{index}}',
      },
      audio: {
        name: 'Audio prima',
        description: 'Ascolta e ricorda con carte solo audio',
      },
      custom: {
      ...
      backlog: {
        name: 'Recupero arretrato',
        description: 'Supera l\'obiettivo giornaliero e riduci l\'arretrato delle revisioni',
        sessionSize: 'Dimensione sessione arretrato',
        priorityHint: 'Dà priorità alle revisioni in ritardo, poi alle revisioni dovute, poi alle nuove carte.',
      },
    },
    backlog: {
      label: 'Arretrato: {{count}}',
    },
    tapAgainToStart: 'Seleziona di nuovo per iniziare',
    ...
    weakCards: {
      none: 'Nessuna carta difficile dall\'ultima sessione.',
      noneAgain: 'Nessuna carta "Ancora" dall\'ultima sessione.',
      showAgainOnly: 'Mostra solo "Ancora"',
    ...
    ankiBackup: {
      enable: 'Abilita backup cloud',
      disable: 'Disabilita backup cloud',
      localOnly: 'Solo locale (non salvato)',
      reimportRequired: 'Reimporta questo mazzo per abilitare il backup cloud.',
      disableConfirmTitle: 'Disabilitare il backup cloud?',
      disableConfirmMessage: 'Questo rimuoverà "{{name}}" dal backup cloud e lo manterrà solo localmente.',
      disableConfirmAction: 'Disabilita backup',
      disabling: 'Disabilitazione backup cloud per "{{name}}"...',
      disabled: 'Backup cloud disabilitato.',
    },
    image: {
    ...
    errors: {
      ...
      deckLimitReached: 'Hai raggiunto il limite di creazione dei mazzi per questo piano',
      deckMarketLimitReached: 'Gli utenti gratuiti possono avere un solo mazzo DeckMarket alla volta. Elimina prima il tuo attuale mazzo DeckMarket.',
      deckMarketOnlyForFree: 'Gli utenti gratuiti possono aggiungere mazzi solo da DeckMarket.',
    },
    limits: {
    ...
    mastery: {
      title: 'Padronanza delle flashcard',
      subtitle: 'misurata dalla serie',
      ...
      streak2: 'Serie 2',
      streak3plus: 'Serie 3+',
      empty: 'Nessun dato di serie ancora.',
    },
    momentum: {
      title: 'Coach del ritmo',
      subtitle: 'Una vittoria veloce per mantenere il ritmo',
      caughtUp: 'Sei in pari per oggi.',
      recommendation: 'Prova {{count}} carte da {{deck}} per mantenere la tua serie.',
      start: 'Avvia sessione veloce',
    },
    heat: {
      title: 'Focus calore',
      subtitle: 'Le carte più fragili in questo momento',
      empty: 'Nessuna carta fragile rilevata per ora.',
      review: 'Rivedi',
      untitled: 'Carta senza titolo',
      hot: 'Caldo',
      warm: 'Tiepido',
      cool: 'Fresco',
      viewAll: 'Vedi tutto',
    ...
    stats: {
      ...
      studyTime: 'Tempo di studio',
      learningProgress: 'Progresso di apprendimento',
      cardProgress: 'Progresso delle carte',
      deckPerformance: 'Prestazioni dei mazzi',
      studyNext: 'Studia prossimo',
      studyCta: 'Studia',
    ...
    bulk: {
      ...
      confirmDelete: 'Sei sicuro di voler eliminare {{count}} mazzi? Questa azione non può essere annullata.',
      confirmMerge: 'Sei sicuro di voler unire {{count}} mazzi in uno?',
      confirmArchive: 'Sei sicuro di voler archiviare {{count}} mazzi?',
      deleteSuccess: '{{count}} mazzi eliminati con successo',
      deleteFailed: 'Eliminazione dei mazzi non riuscita',
      exportSuccess: '{{count}} mazzi esportati con successo',
      exportFailed: 'Esportazione dei mazzi non riuscita',
      mergeSuccess: '{{count}} mazzi uniti con successo',
      mergeFailed: 'Unione dei mazzi non riuscita',
      duplicateSuccess: '{{count}} mazzi duplicati con successo',
      duplicateFailed: 'Duplicazione dei mazzi non riuscita',
      mergedDeckName: 'Mazzo unito',
      mergedDeckDescription: 'Unito da {{count}} mazzi',
    },
  },
  conjugation: {
    title: 'Coniugazione',
    ...
    sections: {
      ...
      helpResources: {
        ...
        viewTutorial: {
          ...
          description: 'Scopri perché Moshimoshi è stato creato e come usarlo',
        },
        emailSupport: {
  ...
  anki: {
    ...
    backupToCloud: 'Backup di questo mazzo nel cloud',
    backupToCloudHint: 'Abilita il ripristino multi-dispositivo e la conservazione sicura.',
  ...
  kanjiBrowser: {
    ...
    collection: {
      title: 'La Mia Collezione di Kanji',
      subtitle: '{count} kanji imparati • Continua così!',
      studyAll: 'Studia tutti',
      reviewAll: 'Ripassa tutti',
      studyAllTooltip: 'Studia tutti i kanji imparati',
      ...
      confirmRemoveMessage: 'Sei sicuro di voler rimuovere questo kanji dalla tua collezione imparata? Questo resetterà tutti i progressi per questo kanji.',
      confirmRemoveButton: 'Rimuovi',
    },
    studyGating: {
      slotsTitle: 'Slot di studio kanji',
      slotsHelper: 'I kanji sbloccati possono sempre essere studiati di nuovo',
      guestSlotsHelper: 'Accedi per sbloccare kanji da studiare',
      unlimited: 'Studio kanji illimitato',
      unlockedLabel: 'sbloccati',
      remainingLabel: 'rimanenti',
      usedLabel: 'usato',
      guestDenied: 'Accedi per sbloccare e studiare i kanji nel Browser Kanji',
      signIn: 'Accedi',
      limitReached: 'Hai sbloccato tutti gli {unlocked} spazi di studio kanji gratuiti. I kanji selezionati includono {new} nuovi kanji. Passa a Premium per sbloccare lo studio illimitato dei kanji.',
      upgradeToPremium: 'Passa a Premium',
      alreadyUnlocked: 'Continua con i kanji già sbloccati',
      newlyUnlocked: '{count} nuovi kanji sbloccati per lo studio',
    },
    browseFilters: {
      all: 'Tutti',
      unlocked: 'Sbloccati',
  ...
  tts: {
    ...
    warnings: {
      nonJapaneseText: 'L\'audio è disponibile solo per il testo in giapponese',
    },
    settings: {
  ...
  kanjiMasteryTool: {
    ...
    answerMode: 'Modalità di Risposta',
    ...
    errorReviewSessionEmpty: 'Non ci sono abbastanza kanji da ripassare per riempire una sessione. Impara più kanji o attendi che i ripassi siano in scadenza.',
    howItWorks: 'Come Funziona',
    ...
    exitConfirmTitle: 'Uscire dalla sessione?',
    ...
    drawingApproach: {
      ...
      completionMessage: 'Pratica completata! Ottimo lavoro.',
    },
  },
  qa: {
    title: 'Casa da Tè',
  ...
  intro: {
    panel1: {
      eyebrow: 'Perché Moshimoshi Esiste',
      line1: 'Imparare il giapponese aveva iniziato a stancarmi.',
      line2: 'Passavo continuamente da un\'app all\'altra — kanji, grammatica, flashcard, video.',
      line3: 'Più strumenti non significavano imparare meglio, ma solo più attrito.',
      line4: 'Ho creato Moshimoshi come uno spazio calmo dove tutto funziona insieme, per rallentare, concentrarsi e imparare dal giapponese reale.',
    },
    panel2: {
      eyebrow: 'Un Piccolo Progetto Umano',
      line1: 'Moshimoshi è costruito da una sola persona, non da un team.',
      line2: 'È progettato, sviluppato e mantenuto con calma e attenzione.',
      line3: 'I bug possono succedere.',
      line4: 'In quei momenti, gentilezza e pazienza fanno la differenza.',
      line5: 'Questa app cresce insieme ai suoi utenti.',
    },
    panel3: {
      eyebrow: 'Una Cassetta degli Attrezzi per Studenti',
      line1: 'Anche io sto imparando il giapponese.',
      line2: 'Moshimoshi non è qui per insegnarti il giapponese.',
      line3: 'È il luogo dove raccolgo tutti gli strumenti di cui ho bisogno per studiare.',
      line4: 'Puoi usarli come preferisci.',
      line5: 'Non esiste un unico percorso.',
    },
    panel4: {
      eyebrow: 'Prima L\'Immersione',
      line1: 'Il mio approccio parte dall\'immersione.',
      line2: 'Per questo Moshimoshi dà valore allo shadowing, ai libri e alle notizie.',
      line3: 'I libri di testo e le flashcard supportano l\'immersione, non la sostituiscono.',
      line4: 'Il giapponese reale viene prima di tutto.',
    },
    panel5: {
      eyebrow: 'Come Usare Moshimoshi',
      line1: 'Non esiste un modo corretto di usare Moshimoshi.',
      line2: 'Puoi studiare vocaboli, ripassare flashcard, leggere storie o esplorare i kanji.',
      line3: 'Usalo come una cassetta degli attrezzi, non come una lista di cose da fare.',
      line4: 'I progressi arrivano dalla costanza, non dall\'intensità.',
    },
    panel6: {
      eyebrow: 'Shadowing YouTube',
      line1: 'Guardi già contenuti giapponesi.',
      line2: 'Moshimoshi ti aiuta a imparare davvero da essi.',
      line3: 'Metti in pausa, ripeti, salva parole e frasi e pratica il parlato.',
      line4: 'Niente dialoghi artificiali.',
      line5: 'Solo immersione, resa utilizzabile.',
    },
    closing: {
      line1: 'Prenditi il tuo tempo.',
      line2: 'Il giapponese non è una gara.',
      getStarted: 'Inizia',
      backToSettings: 'Torna alle Impostazioni',
      loading: 'Caricamento...',
    },
    progressOf: 'di',
    swipeHint: 'Scorri o usa le frecce per continuare',
  },
  congratulations: 'Congratulazioni!',
  success: 'Successo',
  teaHouse: {
  ...
  deckmarket: {
    title: 'Deck Market',
    subtitle: 'Sfoglia e scarica deck Anki',
    search: 'Cerca deck...',
    filters: {
      all: 'Tutti',
      jlpt: 'Livello JLPT',
    ...
    deck: {
      ...
      tags: 'Tag',
      downloads: 'Download',
      noDecks: 'Nessun deck disponibile al momento',
      notFound: 'Deck non trovato',
      changelog: 'Registro modifiche',
      loginRequired: 'Accedi per sfogliare i deck',
      addToFlashcards: 'Aggiungi alle Flashcard',
      adding: 'Aggiunta in corso...',
      added: 'Aggiunto',
      alreadyAdded: 'Già aggiunto',
      addFailed: 'Impossibile aggiungere il deck. Riprova.',
    ...
    preview: {
      ...
      subtitle: 'Prime 10 carte',
      loading: 'Caricamento anteprima...',
      unavailable: 'Anteprima non disponibile per questo deck',
      front: 'Fronte',
      back: 'Retro',
    },
    notes: {
      title: 'Note di lezione',
      subtitle: 'Scarica note PDF per il tuo studio del giapponese',
      downloadPdf: 'Scarica PDF',
      previewTitle: 'Anteprima PDF',
      previewSubtitle: 'Leggi le note qui',
      previewLoading: 'Caricamento anteprima...',
      previewUnavailable: 'Anteprima non disponibile per questa nota',
      downloadFailed: 'Impossibile avviare il download. Riprova.',
      notFound: 'Nota non trovata',
      noNotes: 'Nessuna nota disponibile al momento',
    },
    pagination: {
      prev: 'Precedente',
      next: 'Successivo',
    ...
    admin: {
      ...
      uploadVersion: 'Carica nuova versione',
      ...
      slug: 'Slug (ID)',
      slugHelp: 'Identificatore compatibile con URL (es. genki2-lesson-01)',
      description: 'Descrizione',
      tags: 'Tag (separati da virgole)',
      jlpt: 'Livello JLPT',
      language: 'Lingua',
      ...
      confirmDelete: 'Sei sicuro? Questa operazione non può essere annullata.',
      deckCreated: 'Deck creato con successo',
      deckUpdated: 'Deck aggiornato con successo',
      versionUploaded: 'Versione caricata con successo',
      versionDeleted: 'Versione eliminata',
      titleRequired: 'Title is required.',
      uploadFailed: 'Caricamento non riuscito. Riprova.',
      invalidFile: 'Sono accettati solo file .apkg',
      invalidCsv: 'Sono accettati solo file .csv',
      fileTooLarge: 'Il file supera il limite di 200MB',
      noVersions: 'Nessuna versione caricata finora',
      selectFile: 'Seleziona file .apkg',
      selectApkgFile: 'Seleziona file .apkg',
  ...
  vocabularyFirstStudy: {
    meaningCard: {
      meaning: 'Significato',
      alsoMeans: 'Può significare anche:',
      introduction: 'Introduzione',
      strokes: '{count} tratti',
    },
    vocabularyCard: {
      learnThisWord: 'Impara questa parola',
      usingKanji: 'Usando il kanji {kanji}',
      onyomi: "On'yomi",
      kunyomi: "Kun'yomi",
      common: 'Comune',
      meaning: 'Significato',
    ...
    readingSummaryCard: {
      readingSummary: 'Riepilogo letture',
      allWaysToRead: 'Tutti i modi di leggere questo kanji',
      onyomiLabel: "On'yomi",
      kunyomiLabel: "Kun'yomi",
      wordsYouLearned: 'Parole imparate',
      summary: 'Riepilogo',
      moreReadingsAvailable: 'Altre letture disponibili nei dettagli',
    },
    readingMatchCard: {
      title: 'Abbina parole e letture',
      subtitle: 'Abbina ogni parola alla lettura appena imparata',
      instructions: 'Tocca una parola e poi la sua lettura',
      completed: 'Tutte le coppie sono corrette',
      words: 'Parole',
      readings: 'Letture',
    },
    progress: {
      cardProgress: 'Carta {current} di {total} • Kanji {kanjiCurrent} / {kanjiTotal}',
    },
  },
};
