export const strings = {
  ...
  account: {
    ...
    deleteAccountDialog: {
      ...
      reasons: {
        not_using: 'アプリを使わなくなった',
        privacy_concerns: 'プライバシーの懸念',
        found_alternative: '他のサービスを見つけた',
        technical_issues: '技術的な問題',
        too_expensive: '料金が高い',
        other: 'その他',
      },
      feedbackLabel: 'ご意見をお聞かせください（任意）',
      feedbackPlaceholder: '改善のためにご協力ください...',
      confirmPhraseLabel: '{phrase}と入力して確認',
      confirmPhrase: 'DELETE MY ACCOUNT',
      recoveryInfo:
        'アカウントはすぐに無効化され、30日後に完全に削除されます。この期間内にサポートにご連絡いただければ、アカウントを復旧できます。',
      deleting: '削除中...',
    },
    toastMessages: {
      profileUpdated: 'プロフィールが正常に更新されました！',
      accountDeletionRequested: 'アカウント削除がリクエストされました。サポートにお問い合わせください。',
      accountDeletionSuccess: 'アカウントの削除が予定されました。サインアウトされます。',
      confirmPhraseError: '確認のため「DELETE MY ACCOUNT」と入力してください',
    },
  },
  statistics: {
  ...
  errors: {
    auth: {
      ...
      accountScheduledForDeletion: 'このアカウントは削除予定です。30日以内にサポートに連絡して復旧してください。',
  ...
  entitlements: {
    ...
    messages: {
      ...
      lookupLimitReached: '本日の検索上限に達しました。明日もう一度お試しください。',
      ...
      signUpForMore: '無料でサインアップして毎日の練習回数を増やしましょう',
  ...
  pricing: {
    ...
    planNames: {
      ...
      premiumYearly: 'プレミアム（年額）',
    },
    planDescriptions: {
      free: '基本機能から始めよう',
      premiumMonthly: '月額でフルアクセス',
      premiumYearly: '年額でお得にフルアクセス',
    },
    billing: {
      monthly: '月額',
      yearly: '年額',
    ...
    features: {
      title: '含まれる機能',
      free: {
        startLearning: '今日から学習を始めよう',
        dailyPractice: 'かな・漢字・ドリルの毎日練習',
        limitedStoriesNews: 'ストーリーとニュースは制限あり',
        basicProgressTracking: '基本的な進捗管理',
        learnAtYourPace: '自分のペースで学べる',
      },
      monthly: {
        everythingFree: '無料プランの全て＋',
        learnFaster: '無制限の練習で上達を加速',
        readMore: 'ストーリー・ニュース・コミックが無制限',
        goDeeper: 'Kanji Connectionフル + 教科書語彙でさらに深く',
        buildHabits: '無制限ドリル＆習得で習慣化',
        crossDeviceSync: 'デバイス間同期で進捗をどこでも',
        prioritySupport: '優先サポート',
        futureFeaturesUnlimited: '新機能はすべて追加料金なしで無制限',
      },
      yearly: {
        everythingMonthly: 'プレミアムマンスリーの全機能',
        twoMonthsFree: 'ベストバリュー — 7%お得（2か月分無料）',
      },
    },
    trust: {
  ...
  lists: {
    ...
    deleteAllDialog: {
      title: 'すべてのリストを削除',
      message: '{{count}}件のリストをすべて削除してもよろしいですか？この操作は元に戻せず、すべてのアイテムが完全に削除されます。',
      confirm: 'すべて削除（{{count}}件）',
    },
    labels: {
    ...
    success: {
      ...
      allDeleted: '{{count}}件のリストがすべて削除されました',
    ...
    errors: {
      ...
      deleteFailed: 'リストの削除に失敗しました',
      someDeleteFailed: '{{success}}件のリストを削除、{{failed}}件が失敗',
  ...
  flashcards: {
    ...
    modes: {
      ...
      mistakeReplay: {
        name: 'ミスリプレイ',
        description: '前回のセッションのミスを復習',
        history: 'セッション履歴',
        session: 'セッション {{index}}',
      },
      audio: {
        name: 'オーディオファースト',
        description: '音声のみのカードで聞いて思い出す',
      },
      custom: {
        name: 'カスタムセッション',
      ...
      backlog: {
        name: 'バックログ消化',
        description: '今日の目標を超えて、残りの復習バックログに取り組む',
        sessionSize: 'バックログセッションサイズ',
        priorityHint: '期限切れの復習、期日の復習、新しいカードの順に優先されます。',
      },
    },
    backlog: {
      label: 'バックログ: {{count}}',
    },
    tapAgainToStart: 'もう一度選択して開始',
    startStudying: '学習を開始',
    ...
    weakCards: {
      none: '前回のセッションに苦手カードはありません。',
      noneAgain: '前回のセッションに「もう一度」のカードはありません。',
      showAgainOnly: '「もう一度」のみ表示',
      showAll: 'すべて表示',
      clear: 'クリア',
    },
    difficulty: {
    ...
    mastery: {
      ...
      streak2: 'ストリーク 2',
      streak3plus: 'ストリーク 3+',
      empty: 'まだストリークデータがありません。',
    },
    momentum: {
      title: 'モメンタムコーチ',
      subtitle: 'リズムを保つためのクイックウィン',
      caughtUp: '今日は全て完了しています。',
      recommendation: 'ストリークを維持するために{{deck}}から{{count}}枚のカードを試しましょう。',
      start: 'クイックセッションを開始',
    },
    heat: {
      title: 'ヒートフォーカス',
      subtitle: '今最も忘れやすいカード',
      empty: 'まだ脆弱なカードは検出されていません。',
      review: '復習',
      untitled: '無題のカード',
      hot: 'ホット',
      warm: 'ウォーム',
    ...
    ankiBackup: {
      enable: 'クラウドバックアップを有効にする',
      disable: 'クラウドバックアップを無効にする',
      localOnly: 'ローカルのみ（バックアップされていません）',
      reimportRequired: 'クラウドバックアップを有効にするには、このデッキを再インポートしてください。',
      disableConfirmTitle: 'クラウドバックアップを無効にしますか？',
      disableConfirmMessage: 'これにより「{{name}}」がクラウドバックアップから削除され、ローカルのみになります。',
      disableConfirmAction: 'バックアップを無効にする',
      disabling: '「{{name}}」のクラウドバックアップを無効にしています...',
      disabled: 'クラウドバックアップが無効になりました。',
    },
    image: {
    ...
    errors: {
      ...
      deckLimitReached: 'このプランのデッキ作成上限に達しました',
      deckMarketLimitReached: '無料ユーザーはDeckMarketデッキを1つまで追加できます。別のDeckMarketデッキを追加するには、現在のDeckMarketデッキを削除してください。',
      deckMarketOnlyForFree: '無料ユーザーはDeckMarketからのみデッキを追加できます。',
    },
    limits: {
    ...
    bulk: {
      ...
      archive: 'アーカイブ',
      addTags: 'タグを追加',
      confirmDelete: '{{count}}件のデッキを削除しますか？この操作は取り消せません。',
      confirmMerge: '{{count}}件のデッキを1つに結合しますか？',
      confirmArchive: '{{count}}件のデッキをアーカイブしますか？',
      deleteSuccess: '{{count}}件のデッキを削除しました',
      deleteFailed: 'デッキの削除に失敗しました',
      exportSuccess: '{{count}}件のデッキをエクスポートしました',
      exportFailed: 'デッキのエクスポートに失敗しました',
      mergeSuccess: '{{count}}件のデッキを結合しました',
      mergeFailed: 'デッキの結合に失敗しました',
      duplicateSuccess: '{{count}}件のデッキを複製しました',
      duplicateFailed: 'デッキの複製に失敗しました',
      mergedDeckName: '結合デッキ',
      mergedDeckDescription: '{{count}}件のデッキから結合',
    },
  },
  conjugation: {
    title: '活用',
  ...
  anki: {
    ...
    backupToCloud: 'このデッキをクラウドにバックアップ',
    backupToCloudHint: 'デバイス間での復元と安全な保管を有効にします。',
  ...
  kanjiBrowser: {
    ...
    collection: {
      title: 'マイ漢字コレクション',
      subtitle: '{count}個の漢字を習得 • 頑張っていますね！',
      studyAll: '全て学習',
      reviewAll: '全て復習',
      studyAllTooltip: '習得した漢字を全て学習',
      ...
      confirmRemoveMessage: 'この漢字を習得済みコレクションから削除してもよろしいですか？この漢字の進捗がすべてリセットされます。',
      confirmRemoveButton: '削除',
    },
    studyGating: {
      slotsTitle: '漢字学習スロット',
      slotsHelper: '解除済みの漢字はいつでももう一度学習できます',
      guestSlotsHelper: '学習用の漢字を解除するにはログインしてください',
      unlimited: '漢字学習は無制限です',
      unlockedLabel: '解除済み',
      remainingLabel: '残り',
      usedLabel: '使用済み',
      guestDenied: '漢字ブラウザで漢字をアンロックして学習するにはログインしてください',
      signIn: 'ログイン',
      limitReached: '無料の漢字学習枠{unlocked}個をすべてアンロックしました。選択した漢字には{new}個の新しい漢字が含まれています。プレミアムにアップグレードして無制限の漢字学習をアンロックしましょう。',
      upgradeToPremium: 'プレミアムにアップグレード',
      alreadyUnlocked: 'すでにアンロック済みの漢字で続行',
      newlyUnlocked: '{count}個の新しい漢字を学習用にアンロックしました',
    },
    browseFilters: {
      all: 'すべて',
      unlocked: '解除済み',
  ...
  tts: {
    ...
    warnings: {
      nonJapaneseText: '音声は日本語テキストのみ対応しています',
    },
    settings: {
      title: '音声設定',
      voice: '音声',
  ...
  deckmarket: {
    ...
    deck: {
      ...
      changelog: '変更履歴',
      loginRequired: 'デッキを閲覧するにはログインしてください',
      addToFlashcards: 'フラッシュカードに追加',
      adding: '追加中...',
      added: '追加済み',
      alreadyAdded: '追加済み',
    ...
    preview: {
      ...
      subtitle: '最初の10枚',
      loading: 'プレビューを読み込み中...',
      unavailable: 'このデッキのプレビューは利用できません',
      front: '表',
      back: '裏',
    },
    notes: {
      title: 'レッスンノート',
      subtitle: '日本語学習用のPDFノートをダウンロードできます',
      downloadPdf: 'PDFをダウンロード',
      previewTitle: 'PDFプレビュー',
      previewSubtitle: 'ここでノートを確認できます',
      previewLoading: 'プレビューを読み込み中...',
      previewUnavailable: 'このノートのプレビューは利用できません',
      downloadFailed: 'ダウンロードの開始に失敗しました。もう一度お試しください。',
      notFound: 'ノートが見つかりません',
      noNotes: '現在、ノートはありません',
    },
    pagination: {
      prev: '前へ',
      next: '次へ',
    ...
    admin: {
      ...
      publishNow: '今すぐ公開',
      slug: 'スラッグ（ID）',
      slugHelp: 'URL用の識別子（例：genki2-lesson-01）',
      titleLabel: 'Title',
      description: '説明',
      tags: 'タグ（カンマ区切り）',
      jlpt: 'JLPTレベル',
      ...
      deckCreated: 'デッキが作成されました',
      deckUpdated: 'デッキが更新されました',
      versionUploaded: 'バージョンがアップロードされました',
      versionDeleted: 'バージョンが削除されました',
      ...
      invalidFile: '.apkgファイルのみ対応しています',
      invalidCsv: 'CSVファイルのみ対応しています',
      invalidMd: 'Only .md files are accepted',
      fileTooLarge: 'ファイルサイズが200MBの制限を超えています',
      fileTooLargeMd: 'File exceeds 50MB limit',
      noVersions: 'まだバージョンがアップロードされていません',
      noNoteVersions: 'No note versions uploaded yet',
      selectFile: '.apkgファイルを選択',
      selectApkgFile: '.apkgファイルを選択',
  ...
  vocabularyFirstStudy: {
    ...
    vocabularyCard: {
      learnThisWord: 'この単語を学ぼう',
      usingKanji: '使う漢字: {kanji}',
      onyomi: '音読み',
      kunyomi: '訓読み',
      common: 'よく使う',
      meaning: '意味',
    ...
    readingSummaryCard: {
      readingSummary: '読み方まとめ',
      allWaysToRead: 'この漢字のすべての読み方',
      onyomiLabel: '音読み',
      kunyomiLabel: '訓読み',
    ...
    readingMatchCard: {
      title: '単語と読み方を合わせよう',
      subtitle: '学んだ読み方と単語を組み合わせましょう',
      instructions: '単語を選んでから、対応する読み方を選んでください',
      completed: 'すべて正しく合わせました',
      words: '単語',
      readings: '読み方',
    },
    progress: {
      cardProgress: 'カード {current} / {total} ・ 漢字 {kanjiCurrent} / {kanjiTotal}',
    },
  },
};
