export const strings = {
  ...
  pricing: {
    ...
    features: {
      title: '含まれる機能',
      free: {
        hiragana: 'ひらがな練習 1日5回',
        katakana: 'カタカナ練習 1日5回',
        basicTracking: '基本的な進捗追跡',
        communitySupport: 'コミュニティサポート',
      },
      monthly: {
        unlimitedHiragana: 'ひらがな練習無制限',
        unlimitedKatakana: 'カタカナ練習無制限',
        unlimitedKanji: '漢字練習無制限',
        kanjiConnection: '限定漢字コネクション',
        textbookVocab: '教科書語彙への限定アクセス',
        moshiComics: 'もしコミックスへの限定アクセス',
        advancedSRS: '高度なSRSアルゴリズム',
        ankiImports: 'Ankiインポート',
        unlimitedLists: 'マイリスト無制限',
        prioritySupport: '優先サポート',
        cancelAnytime: 'いつでもキャンセル可能',
      },
      yearly: {
