export const strings = {
  ...
  dashboard: {
    ...
    welcome: {
      firstVisit: 'Willkommen zu Ihrem Japanisch-Lernabenteuer! Doshi ist hier, um Sie zu führen.',
  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        hiragana: '5 Hiragana-Übungen pro Tag',
        katakana: '5 Katakana-Übungen pro Tag',
        basicTracking: 'Grundlegende Fortschrittsverfolgung',
        communitySupport: 'Community-Support',
      },
      monthly: {
        unlimitedHiragana: 'Unbegrenzte Hiragana-Übungen',
        unlimitedKatakana: 'Unbegrenzte Katakana-Übungen',
        unlimitedKanji: 'Unbegrenzte Kanji-Übungen',
        kanjiConnection: 'Exklusive Kanji Connection',
        textbookVocab: 'Exklusiver Zugang zum Lehrbuch-Vokabular',
        moshiComics: 'Exklusiver Zugang zu Moshi Comics',
        advancedSRS: 'Erweiterter SRS-Algorithmus',
        ankiImports: 'Anki-Importe',
        unlimitedLists: 'Unbegrenzte Eigene Listen',
        prioritySupport: 'Priority Support',
        cancelAnytime: 'Jederzeit kündbar',
      },
      yearly: {
        ...
        save25: 'Spare 25% gegenüber monatlich',
      },
    },
    comparison: {
    ...
    pricingComparison: {
      ...
      moshimoshiPricing: {
        ...
        premium: {
          ...
          monthlyPrice: '£8.99',
          yearlyPrice: '£8.33',
          yearlyTotal: '£99.9/Jahr',
          period: '/Monat',
          badge: 'BESTER WERT',
          features: [
            'Alles in Kostenlos, plus:',
            'Unbegrenztes YouTube-Shadowing',
            'Alle JLPT-Level (N5-N1)',
            'Unbegrenzte KI-Geschichten & Erklärungen',
            'Japanischer Nachrichtenleser',
            'Anki-Export & Cloud-Synchronisierung',
            'Prioritäts-Support',
          ],
          cta: '7-tägige kostenlose Testversion starten',
      ...
      allFeatures: {
        ...
        categories: {
          ...
          studyFeatures: {
            ...
            items: [
              'Vollständiges Hiragana/Katakana',
  ...
  story: {
    ...
    lockScreenUnlockText: 'Tippe 3× auf Doshi zum Entsperren',
