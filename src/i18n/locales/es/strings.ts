export const strings = {
  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        hiragana: '5 sesiones de práctica de Hiragana por día',
        katakana: '5 sesiones de práctica de Katakana por día',
        basicTracking: 'Seguimiento básico de progreso',
        communitySupport: 'Soporte de la comunidad',
      },
      monthly: {
        unlimitedHiragana: 'Práctica ilimitada de Hiragana',
        unlimitedKatakana: 'Práctica ilimitada de Katakana',
        unlimitedKanji: 'Práctica ilimitada de Kanji',
        kanjiConnection: 'Kanji Connection exclusivo',
        textbookVocab: 'Acceso exclusivo al vocabulario de libros de texto',
        moshiComics: 'Acceso exclusivo a Moshi Comics',
        advancedSRS: 'Algoritmo SRS avanzado',
        ankiImports: 'Importaciones de Anki',
        unlimitedLists: 'Mis Listas ilimitadas',
        prioritySupport: 'Soporte prioritario',
        cancelAnytime: 'Cancela en cualquier momento',
      },
      yearly: {
