export const strings = {
  ...
  youtubeShadowing: {
    ...
    beta: {
      label: 'Beta',
      tooltip: 'Las herramientas de shadowing están mejorando mientras refinamos la sincronización de transcripciones.',
    },
    header: {
  ...
  flashcards: {
    ...
    modes: {
      ...
      backlog: {
        name: 'Reducir atraso',
        description: 'Supera tu objetivo diario y reduce el atraso de repasos pendientes',
        sessionSize: 'Tamaño de sesión de atraso',
        priorityHint: 'Prioriza repasos atrasados, luego repasos pendientes, luego tarjetas nuevas.',
      },
    },
    backlog: {
      label: 'Atraso: {{count}}',
    },
    tapAgainToStart: 'Selecciona de nuevo para iniciar',
    ...
    errors: {
      ...
      deckLimitReached: 'Has alcanzado el límite de creación de mazos para este plan',
  ...
  kanjiBrowser: {
    ...
    collection: {
      title: 'Mi Colección de Kanji',
      subtitle: '{count} kanji aprendidos • ¡Sigue así!',
      studyAll: 'Estudiar todos',
      reviewAll: 'Repasar todos',
      studyAllTooltip: 'Estudiar todos los kanji aprendidos',
      ...
      confirmRemoveMessage: '¿Estás seguro de que quieres eliminar este kanji de tu colección aprendida? Esto restablecerá todo el progreso de este kanji.',
      confirmRemoveButton: 'Eliminar',
    },
    studyGating: {
      slotsTitle: 'Espacios de estudio de kanji',
      slotsHelper: 'Los kanji desbloqueados siempre se pueden volver a estudiar',
      guestSlotsHelper: 'Inicia sesión para desbloquear kanji para estudiar',
      unlimited: 'Estudio de kanji ilimitado',
      unlockedLabel: 'desbloqueados',
      remainingLabel: 'restantes',
      usedLabel: 'usado',
      guestDenied: 'Inicia sesión para desbloquear y estudiar kanji en el Navegador de Kanji',
      signIn: 'Iniciar sesión',
      limitReached: 'Has desbloqueado todos los {unlocked} espacios gratuitos de estudio de kanji. Los kanji seleccionados incluyen {new} kanji nuevos. Actualiza a Premium para desbloquear estudio ilimitado de kanji.',
      upgradeToPremium: 'Actualizar a Premium',
      alreadyUnlocked: 'Continuando con kanji ya desbloqueados',
      newlyUnlocked: '{count} kanji nuevos desbloqueados para estudiar',
    },
    browseFilters: {
      all: 'Todos',
      unlocked: 'Desbloqueados',
  ...
  vocabularyFirstStudy: {
    meaningCard: {
      meaning: 'Significado',
      alsoMeans: 'También significa:',
      introduction: 'Introducción',
      strokes: '{count} trazos',
    },
    vocabularyCard: {
      learnThisWord: 'Aprende esta palabra',
      usingKanji: 'Usando el kanji {kanji}',
      onyomi: "On'yomi",
      kunyomi: "Kun'yomi",
      common: 'Común',
      meaning: 'Significado',
    ...
    readingSummaryCard: {
      readingSummary: 'Resumen de lecturas',
      allWaysToRead: 'Todas las formas de leer este kanji',
      onyomiLabel: "On'yomi",
    ...
    readingMatchCard: {
      title: 'Relaciona palabras y lecturas',
      subtitle: 'Empareja cada palabra con la lectura que acabas de aprender',
      instructions: 'Toca una palabra y luego su lectura',
      completed: 'Todas las parejas están correctas',
      words: 'Palabras',
      readings: 'Lecturas',
    },
    progress: {
      cardProgress: 'Tarjeta {current} de {total} • Kanji {kanjiCurrent} / {kanjiTotal}',
    },
  },
};
