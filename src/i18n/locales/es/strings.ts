export const strings = {
  ...
  landing: {
    ...
    hero: {
      ...
      description: "Domina hiragana, katakana y kanji con lecciones breves y repetición espaciada que hace que el aprendizaje se mantenga!",
    ...
    features: {
      personalizedLearning: {
        ...
        description: "Las lecciones impulsadas por IA se adaptan a tu ritmo y estilo de aprendizaje",
      },
      stayMotivated: {
  ...
  dashboard: {
    ...
    welcome: {
      firstVisit: "¡Bienvenido a tu aventura de aprendizaje de japonés! Doshi está aquí para guiarte.",
