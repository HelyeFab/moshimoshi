export const strings = {
  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        hiragana: '5 sessions de pratique Hiragana par jour',
        katakana: '5 sessions de pratique Katakana par jour',
        basicTracking: 'Suivi des progrès de base',
        communitySupport: 'Support communautaire',
      },
      monthly: {
        unlimitedHiragana: 'Pratique Hiragana illimitée',
        unlimitedKatakana: 'Pratique Katakana illimitée',
        unlimitedKanji: 'Pratique Kanji illimitée',
        kanjiConnection: 'Kanji Connection exclusif',
        textbookVocab: 'Accès exclusif au vocabulaire des manuels',
        moshiComics: 'Accès exclusif à Moshi Comics',
        advancedSRS: 'Algorithme SRS avancé',
        ankiImports: 'Importations Anki',
        unlimitedLists: 'Mes Listes illimitées',
        prioritySupport: 'Support prioritaire',
        cancelAnytime: 'Annulez à tout moment',
      },
      yearly: {
