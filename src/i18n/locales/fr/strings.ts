  ...
  pricing: {
    ...
    features: {
      ...
      free: {
        ...
        basicProgressTracking: 'Suivi de progression de base',
      },
      monthly: {
        everythingFree: 'Tout dans Gratuit, plus :',
        unlimitedMoodboards: 'Moodboards illimités',
        unlimitedStories: 'Histoires illimitées',
        unlimitedNews: 'Articles d\'actualité illimités',
        unlimitedDrawPractice: 'Pratique de dessin illimitée',
        ...
        drillCustomLists: 'Pratiquez vos listes personnalisées',
        ankiImports: 'Import de decks Anki',
        unlimitedLists: 'Listes illimitées',
        library: 'Bibliothèque - Livres condensés illimités',
