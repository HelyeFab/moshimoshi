 ...
 * This component handles 404 errors within the locale-prefixed routes.
 */
          ...
          <div className="bg-white/70 dark:bg-dark-800/70 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div className="text-center mb-8">
              ...
              <div className="mt-12 p-4 bg-japanese-mizu/20 dark:bg-japanese-mizuDark/20 rounded-xl">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  <span className="font-bold">Fun fact:</span> In Japanese, "404" can be read as "yo-rei-shi",
                  which sounds like "ghost". Spooky, right?
                </p>
              </div>
            </div>
          </div>
