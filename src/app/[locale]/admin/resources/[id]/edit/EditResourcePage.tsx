...
export default function EditResourcePage({ params }: EditResourcePageProps) {
  ...
  const loadResource = async () => {
    try {
      ...
      setFormData({
        ...
        isPillStyle: resourceData.isPillStyle || false
      });
    } catch (error) {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        sessionStorage.setItem('resourceSuccessMessage',
          formData.status === 'draft' ? 'Resource updated as draft' :
  ...
  // Show loading while fetching resource
  if (loading) {
    return (
  ...
  if (!resource) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-dark-900">
        <p className="text-gray-900 dark:text-white">Resource not found</p>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">
            {strings.admin?.resources?.edit || 'Edit Resource'}
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white dark:bg-dark-850 rounded-lg p-6 border border-gray-200 dark:border-gray-700 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Subtitle</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">URL Slug</label>
                <input
                  type="text"
                  value={formData.slug}
                ...
                />
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">URL: /resources/{formData.slug}</p>
              </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Excerpt</label>
              <textarea
          ...
          {/* Image Section - Same as NewResourcePage */}
          <div className="bg-white dark:bg-dark-850 rounded-lg p-6 border border-gray-200 dark:border-gray-700 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Image URL</label>
                <input
                  type="url"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Image Alt Text</label>
                <input
                  type="text"
          ...
          {/* Publishing Options - Same as NewResourcePage */}
          <div className="bg-white dark:bg-dark-850 rounded-lg p-6 border border-gray-200 dark:border-gray-700 space-y-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              {formData.status === 'scheduled' && (
                <div>
                  <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Scheduled For</label>
                  <input
                    type="datetime-local"
          ...
          {/* SEO - Same as NewResourcePage */}
          <div className="bg-white dark:bg-dark-850 rounded-lg p-6 border border-gray-200 dark:border-gray-700 space-y-4">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white">SEO</h2>

            <div>
              <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">SEO Title</label>
              <input
                type="text"
              ...
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{formData.seoTitle.length}/60 characters</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">SEO Description</label>
              <textarea
              ...
              />
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{formData.seoDescription.length}/160 characters</p>
            </div>
          </div>
