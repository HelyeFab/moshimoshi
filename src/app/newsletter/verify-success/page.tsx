            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-green-700 dark:text-green-300 mt-1">
                  You'll receive our latest Japanese learning tips, resources, and exclusive content directly to your inbox.
                </p>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <ul className="text-sm text-blue-700 dark:text-blue-300 mt-2 space-y-1 list-disc list-inside">
                    <li>Weekly Japanese learning tips</li>
