  ...
  useEffect(() => {
    ...
    if (isStoryContent && pages?.length) {
      ...
      if (fullText) {
        prefetchWordExplanations({
          ...
          .catch((error: unknown) => {
            console.error('Story word explanations prefetch failed:', error)
          })
      }
      return
    }
    ...
    if (isBook && article.content) {
      prefetchWordExplanations({
        ...
        .catch((error: unknown) => {
          console.error('Book word explanations prefetch failed:', error)
        })
      return
    }
    ...
    if (article.content) {
      prefetchWordExplanations({
        ...
        .catch((error: unknown) => {
          console.error('Article word explanations prefetch failed:', error)
        })
    }
  }, [
    article?.id,
