...
export default function CreateListModal({
  ...
  const [selectedEmoji, setSelectedEmoji] = useState<string>(DEFAULT_LIST_EMOJIS[initialType])
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="" size="lg" showCloseButton={!isCreating}>
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          >
            <div
              className={`w-20 h-20 rounded-2xl ${getColorClasses(selectedColor)} flex items-center justify-center text-4xl shadow-lg`}
            >
              {selectedEmoji}
            </div>
          </motion.div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">{t('lists.createDescription')}</p>
        </div>
