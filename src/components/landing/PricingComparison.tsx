...
export default function PricingComparison() {
  ...
  // Competitor apps with their features
      ...
      <div className="max-w-7xl mx-auto">
            ...
            {competitors.map((app, index) => (
              ...
              >
                <div className="mb-4">
                  ...
                  <p className="text-2xl font-bold text-gray-600 dark:text-gray-400 mt-2">{app.price}</p>
                </div>
                ...
                <div className="pt-4 border-t border-gray-200 dark:border-dark-700">
                  <p className="text-xs font-semibold text-red-600 dark:text-red-400 mb-2">Missing:</p>
                  <div className="space-y-1">
                    ...
                    {app.missing.length > 3 && (
                      <p className="text-xs text-gray-400 dark:text-gray-500">
                        +{app.missing.length - 3} more missing...
                      </p>
                    )}
                  </div>
                </div>
          ...
          >
            <div className="text-center">
              <p className="text-lg font-semibold text-red-800 dark:text-red-300 mb-2">
                To get all these features separately, you'd pay:
              </p>
              <p className="text-4xl font-bold text-red-900 dark:text-red-400">
                £240+ per year
              </p>
              <p className="text-sm text-red-700 dark:text-red-400 mt-2">
                (Subscribing to 3-4 different apps)
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            >
              <div className="mb-6">
                <h4 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Free</h4>
                <p className="text-gray-600 dark:text-gray-400 mt-2">Start your journey</p>
                <div className="mt-4">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">Hiragana & Katakana</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 dark:text-gray-300">Basic Kanji (N5)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700 dark:text-gray-300">5 YouTube videos/day</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400">Advanced features locked</span>
                </li>
              </ul>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <p className="text-indigo-100 mt-2">Everything included</p>
                <div className="mt-4">
                  {billingPeriod === 'monthly' ? (
                    <>
                    ...
                    <>
                      <span className="text-4xl font-bold">£{yearlyMonthly}</span>
                      <span className="text-indigo-100">/month</span>
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                  <span>Unlimited YouTube shadowing</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                ...
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                  <span>Unlimited AI stories & explanations</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                  <span>Japanese news reader</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
                  <span>Anki export & cloud sync</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckIcon className="w-5 h-5 text-white flex-shrink-0 mt-0.5" />
        ...
        >
          <div className="bg-gradient-to-r from-indigo-100 to-purple-100 dark:from-indigo-900/30 dark:to-purple-900/30 rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">
              Join thousands learning Japanese the smart way
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              One app, every feature, fraction of the cost. Start your journey today!
            </p>
            <Button
              onClick={() => router.push('/auth/signup')}
