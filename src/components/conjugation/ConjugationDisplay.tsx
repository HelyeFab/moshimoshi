          ...
          return (
            ...
            >
              ...
              >
                ...
                {isExpanded ? (
                  <ChevronDown className="w-5 h-5 text-gray-500 hover:text-gray-700 dark:hover:text-gray-400" />
                ) : (
                  <ChevronRight className="w-5 h-5 text-gray-500 hover:text-gray-700 dark:hover:text-gray-400" />
                )}
              </button>
                              ...
                              <div className="flex items-center gap-3">
                                {showFurigana ? (
                                  <FuriganaText
                                    ...
                                    showFurigana
                                    as="span"
                                    className="text-lg font-medium text-gray-900 dark:text-gray-100 japanese-text"
                                  />
                                ) : (
