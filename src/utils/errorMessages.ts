...
const errorMessageMap: Record<ErrorCode, UserMessage> = {
  ...
  'auth/user-disabled': 'This account has been scheduled for deletion. Contact support within 30 days to recover it.',
  'This account has been disabled': 'This account has been scheduled for deletion. Contact support within 30 days to recover it.',
