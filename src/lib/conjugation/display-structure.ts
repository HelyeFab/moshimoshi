...
export const COMPREHENSIVE_CONJUGATION_STRUCTURE: ConjugationDisplayGroup[] = [
  ...
  },
  {
    ...
    forms: [
      ...
      { label: 'Adjective stem', key: 'taiAdjectiveStem' },
      { label: 'Te-form', key: 'taiTeForm' },
      { label: 'Negative te-form', key: 'taiNegativeTeForm' },
      { label: 'Adverbial Form', key: 'taiAdverbial' },
      { label: 'Provisional Form', key: 'taiProvisional' },
      { label: 'Provisional Negative Form', key: 'taiProvisionalNegative' },
      { label: 'Conditional Form', key: 'taiConditional' },
      { label: 'Conditional Negative Form', key: 'taiConditionalNegative' },
      { label: 'Objective Form', key: 'taiObjective' },
    ],
    collapsible: true,
  ...
  },
  {
    ...
    forms: [
      ...
      { label: 'Masu-stem', key: 'potentialMasuStem' },
  ...
  },
  {
    ...
    forms: [
      ...
      { label: 'Masu stem', key: 'passiveMasuStem' },
  ...
  },
  {
    ...
    forms: [
      ...
      { label: 'Masu stem', key: 'causativeMasuStem' },
  ...
  },
  {
    ...
    forms: [
      ...
      { label: 'Masu stem', key: 'causativePassiveMasuStem' },
