...
export interface SessionStatistics {
  ...
  /**
   * Per-item results for SRS updates (optional for backward compatibility)
   */
  itemResults?: ItemResult[]
}

/**
 * Result of a single item review (for SRS updates)
 */
export interface ItemResult {
  /** Item ID (matches ReviewableContent.id) */
  itemId: string
  ...
  hintsUsed: number
  /** Content metadata (for identifying list items) */
  metadata?: Record<string, any>
}
