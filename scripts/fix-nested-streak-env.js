 ...
 * This version uses environment variables for Firebase Admin credentials
 */
...
if (!admin.apps.length) {
  admin.initializeApp({
    credential: admin.credential.cert({
      ...
      clientEmail: process.env.FIREBASE_ADMIN_CLIENT_EMAIL?.replace(/\\n/g, '\n').trim(),
...
console.log('===========================================')
console.log('\nUsage: node scripts/fix-nested-streak-env.js [userId]')
