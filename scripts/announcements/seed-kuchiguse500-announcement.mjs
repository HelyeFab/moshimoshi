...
/**
 * Seed announcement for Kuchiguse 500 deck update.
 *
 * Usage:
 *   node scripts/announcements/seed-kuchiguse500-announcement.mjs --dry-run
 *   node scripts/announcements/seed-kuchiguse500-announcement.mjs
 *   node scripts/announcements/seed-kuchiguse500-announcement.mjs --publish
 */
...
const markdownPath = path.join(
  ...
  '02-PRODUCTION_DOCS',
  'announcements',
  'kuchiguse500-deck-update.md'
)

const payload = {
  title: 'Kuchiguse 500 Update: Audio + New Deck Flow',
  featureId: 'deckmarket-kuchiguse500-update-2026-03',
  imageUrl: '',
}
...
async function main() {
  ...
  const doc = {
    ...
    createdBy: 'script:seed-kuchiguse500-announcement',
  }
...
main().catch((error) => {
  console.error('[seed-kuchiguse500-announcement] Failed:', error.message)
  process.exit(1)
})
