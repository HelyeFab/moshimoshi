...
/**
 * Seed announcement for Japanese Adjectives 100 Master Deck.
 *
 * Usage:
 *   node scripts/announcements/seed-adjectives100-announcement.mjs --dry-run
 *   node scripts/announcements/seed-adjectives100-announcement.mjs
 *   node scripts/announcements/seed-adjectives100-announcement.mjs --publish
 */
...
const markdownPath = path.join(
  ...
  '02-PRODUCTION_DOCS',
  'announcements',
  'adjectives-100-master-deck.md'
)

const payload = {
  title: '100 Japanese Adjectives Master Deck',
  featureId: 'deckmarket-adjectives100-2026-03',
  imageUrl: '',
}
...
async function main() {
  ...
  const doc = {
    ...
    createdBy: 'script:seed-adjectives100-announcement',
  }
...
main().catch((error) => {
  console.error('[seed-adjectives100-announcement] Failed:', error.message)
  process.exit(1)
})
