...
class DocsAggregator {
  ...
  formatDocument(file) {
    ...
    if (file.content) {
      ...
      formatted += `⚠️ Could not read file: ${file.error}\n`;
    }
  ...
  async aggregate() {
    console.log('🔍 Searching for documentation files...');
    ...
    // Add header
    aggregatedContent += '# 🎌 Moshimoshi Project Documentation\n\n';
    ...
    console.log(`✅ Aggregated documentation written to: ${this.outputFile}`);
    console.log(`📊 File size: ${sizeMB} MB`);
    console.log(`📝 Documents included: ${files.length}`);
  ...
  async watch() {
    ...
    const debouncedAggregate = () => {
      ...
      debounceTimer = setTimeout(async () => {
        console.log('\n♻️  Changes detected, re-aggregating...');
        await this.aggregate();
...
if (require.main === module) {
  ...
  for (let i = 0; i < args.length; i++) {
    switch (args[i]) {
      ...
      case '-h':
        console.log(`
📚 Documentation Aggregator for NotebookLM
