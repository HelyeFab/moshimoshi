 ...
 *
 * Usage:
 *   node scripts/backfill-story-translations.js [--dry-run] [--limit=N] [--story-id=ID]
 *
 * Options:
 ...
 */
async function translateText(japaneseText, jlptLevel) {
  try {
 ...
 */
async function processStory(storyDoc) {
  ...
  for (const doc of snapshot.docs) {
    try {
      ...
      if (result.skipped) {
        ...
        stats.translated++;
        stats.pagesTranslated += result.translatedPages;
      }
    } catch (error) {
