...
_Files that have been fixed and verified. Do not work on these._
...
| `src/components/flashcards/DeckCreator.tsx`                          | 2025-12-02 | Fixed addCard simple format, converted cards to FlashcardContent for VirtualCardList (3 errors)                                                                                                                                            |
| `src/app/api/drill/session/route.ts`                                 | 2025-12-02 | Cast practiceWords to JapaneseWord[], cast sessionData for Firestore update (2 errors)                                                                                                                                                     |
| `src/utils/pokemonManager.ts`                                        | 2025-12-02 | Created MinimalUser interface (uid, email), updated all method signatures - fixes AuthUser/User type mismatches                                                                                                                            |
| `src/lib/drill/srs-word-selector.ts`                                 | 2025-12-02 | Cast vocabulary.JapaneseWord to drill.JapaneseWord (1 error)                                                                                                                                                                               |
| `src/lib/flashcards/MigrationManager.ts`                             | 2025-12-02 | Changed card.tags to card.metadata?.tags (1 error)                                                                                                                                                                                         |
| `src/app/api/blog/[id]/comments/route.ts`                            | 2025-12-02 | Added explicit type with deletedAt for filter access (1 error)                                                                                                                                                                             |
| `src/app/api/news/status/route.ts`                                   | 2025-12-02 | Added explicit type with success property for logs (1 error)                                                                                                                                                                               |
| `src/lib/flashcards/IndexedDBOptimizer.ts`                           | 2025-12-02 | Fixed upgrade transaction - use transaction.objectStore instead of db.transaction (1 error)                                                                                                                                                |
| `src/lib/tts/service.ts`                                             | 2025-12-02 | Saved originalProvider before fallback reassignments (1 error)                                                                                                                                                                             |
| `src/lib/sync/syncOrchestrator.ts`                                   | 2025-12-02 | Created MinimalUser interface, cast for kana progress manager calls                                                                                                                                                                        |
| `src/hooks/useAutoSync.ts`                                           | 2025-12-02 | Added isPremium ?? false for boolean assertion (1 error)                                                                                                                                                                                   |
| `src/components/flashcards/BulkOperations.tsx`                       | 2025-12-02 | Used unknown cast for FlashcardDeck[] with undefined id (1 error)                                                                                                                                                                          |
| `src/lib/entitlements/adminEvaluator.ts`                             | 2025-12-02 | Used unknown cast for EntitlementLog mapping (1 error)                                                                                                                                                                                     |
| `src/lib/pwa/notificationHandler.ts`                                 | 2025-12-02 | Extended NotificationOptions type for ServiceWorker timestamp (1 error)                                                                                                                                                                    |
| `src/lib/pwa/notifications.ts`                                       | 2025-12-02 | Extended NotificationOptions type for ServiceWorker actions (1 error)                                                                                                                                                                      |
| `src/utils/scrapers/scraper-utils.ts`                                | 2025-12-02 | Changed firebase-functions/logger to @/lib/logger (1 error)                                                                                                                                                                                |
| `src/lib/idb/sync-worker.ts`                                         | 2025-12-02 | Added ServiceWorker self declaration as any (1 error)                                                                                                                                                                                      |
| `src/lib/flashcards/SRSHelper.ts`                                    | 2025-12-02 | Fixed ReviewableContentWithSRS format - contentType='custom', tags, supportedModes, calculateNextReview method (1 error)                                                                                                                   |
| `src/app/api/review/migrate-srs/route.ts`                            | 2025-12-02 | Added tags, proper contentType/supportedModes for ReviewableContentWithSRS (1 error)                                                                                                                                                       |
| `src/app/my-videos/MyVideos.tsx`                                     | 2025-12-02 | Changed removeItem to deleteItem method (1 error)                                                                                                                                                                                          |
| `src/lib/anki/importer.ts`                                           | 2025-12-02 | Added ReviewableContent fields (contentType, primaryDisplay, primaryAnswer, difficulty, supportedModes), removed invalid type property (1 error)                                                                                           |
| `src/components/conjugation-help/HelpBanner.tsx`                     | 2025-12-02 | Pass full errorReport instead of analysis to showMultipleHelps (1 error)                                                                                                                                                                   |
| `src/lib/conjugation-help/error-analyzer.ts`                         | 2025-12-02 | Cast word.type to ConjugatableType when isConjugatable, cast enhancedWord to EnhancedJapaneseWord (1 error)                                                                                                                                |
| `src/lib/conjugation-help/error-classifier.ts`                       | 2025-12-02 | Cast detectedForm to keyof ExtendedConjugationForms (1 error)                                                                                                                                                                              |
| `src/lib/email/resend.ts`                                            | 2025-12-02 | Built email payload conditionally, cast to any for Resend API (1 error)                                                                                                                                                                    |
| `src/hooks/useReviewData.ts`                                         | 2025-12-02 | Cast ReviewItem[] to ReviewableContent[] for cacheContent (1 error)                                                                                                                                                                        |
...
- `src/app/api/blog/route.ts`
  > _Note: Some blog routes already fixed - see Fixed Files section_
...
> _All kanji components fixed 2025-12-02 - see Fixed Files section_
...
- `src/components/review/dashboard/StatsOverview.tsx`
  > _Note: KanjiCard.tsx and EntitlementGate.tsx fixed 2025-12-02 - see Fixed Files_
...
> _Note: useFeature.ts fixed 2025-12-02 - see Fixed Files_
...
- `src/hooks/useKeyboardShortcuts.ts`
  > _Note: useKanjiDetails.ts fixed 2025-12-02 - see Fixed Files_
